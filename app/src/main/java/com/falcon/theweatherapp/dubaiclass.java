...
public class dubaiclass extends AppCompatActivity {
    int count;
    String[] w;
    String[] img;
    String[] d;
    ...
    private static final String url = "http://api.openweathermap.org/data/2.5/forecast?id=292223&APPID=fa4ff94bda4c3a3b60a3b30d62821f9b&units=metric";
        ...
        StringRequest m = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {JSONObject obj1 = new JSONObject(response);
                    ...
                    RecyclerView recyclerdubai = (RecyclerView) findViewById(R.id.recyclerdubai);
                    recyclerdubai.setLayoutManager(new LinearLayoutManager(dubaiclass.this));
                    pbar.setVisibility(View.GONE);
                    recyclerdubai.setAdapter(new weatheradapter(w, d, tempmin, tempmax, humidity,img));
            ...
            public void onErrorResponse(VolleyError error) {
                pbar.setVisibility(View.GONE);
                Toast.makeText(dubaiclass.this, "No Internet Connection.Data cannot be updated", Toast.LENGTH_LONG).show();
            }
        });
        RequestQueue queue = Volley.newRequestQueue(dubaiclass.this);
        queue.add(m);
