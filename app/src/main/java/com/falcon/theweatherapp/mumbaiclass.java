...
public class mumbaiclass extends AppCompatActivity {
    int count;
    String[] w;
    String[] img;
    String[] d;
    ...
    private static final String url = "http://api.openweathermap.org/data/2.5/forecast?id=1275339&APPID=fa4ff94bda4c3a3b60a3b30d62821f9b&units=metric";
        ...
        StringRequest m = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {JSONObject obj1 = new JSONObject(response);
                    ...
                    RecyclerView recyclermumbai = (RecyclerView) findViewById(R.id.recyclermumbai);
                    recyclermumbai.setLayoutManager(new LinearLayoutManager(mumbaiclass.this));
            ...
            public void onErrorResponse(VolleyError error) {
                pbar.setVisibility(View.GONE);
                Toast.makeText(mumbaiclass.this, "No Internet Connection.Data cannot be updated", Toast.LENGTH_LONG).show();
                                          }
        });
        RequestQueue queue = Volley.newRequestQueue(mumbaiclass.this);
        queue.add(m);
